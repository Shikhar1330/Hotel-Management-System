...
def Booking():
        ...
        while 1:
            ...
            noofdays= int(input("Number of Days staying:"))
            # checks if any field is not empty
            if n!="" and p1!="" and a!="" and cii!= "" and  coo!= ""  and  noofdays!= "" :
                name.append(n)
                add.append(a)
                checkin.append(cii)
                checkout.append(coo)
                #noofdays.append(nodays)
                break
                  
            else:
                 print("\tName, Phone no.,Checkin,Checkout and number of days cant be  empty & Address cannot be empty..!!")
           
        print("----SELECT ROOM TYPE----")
        print(" 1. One bed with AC and all other necesities")
        print(" 2. Two bed with AC and all other necesitites")
        print(" 3. Three bed with AC and all other necsitities")
        print(" 4. Four bed with AC and all other necesites")
        ...
        # type and it's price
        if ch==0:
            print(" 1.One bed with AC and all other necesities - Rs. 6500")
            print(" 2.Two bed with AC and all other necesitites- Rs. 8000")
            print(" 3.Three bed with AC and all other necsitities-Rs.10000")
            print(" 4.Four bed with AC and all other necesites - Rs. `14000")
            ch=int(input("->"))
        if ch==1:
            room.append('One bed with AC and all other necesities')
            print("Room Type- One bed with AC and all other necesities")  
            price.append(6500)
            print("Price- 6500")
        elif ch==2:
            room.append('Two bed with AC and all other necesitites')
            print("Room Type- Two bed with AC and all other necesitites")
            price.append(8000)
            print("Price- 8000")
        elif ch==3:
            room.append('Three bed with AC and all other necsitities')
            print("Room Type- Three bed with AC and all other necsitities")
            price.append(10000)
            print("Price- 10000")
        elif ch==4:
            room.append('Four bed with AC and all other necesites ')
            print("Room Type-Four bed with AC and all other necesites ")
            price.append(14000)
            print("Price- 14000")
        else:
            print(" Wrong choice..!!")
